...
- 목록은 페이지 진입 시 대회 조직위원회의 [공식 결과 서비스](https://results.asiangames2026.org/#/discipline/BBL/schedule)를 한 번 확인합니다. 카드를 누르면 경기 상세로 이동하며, 상세 화면은 경기 시작 15분 전부터 10초마다 확인하고 종료·취소·연기가 확인되면 자동 갱신을 멈춥니다.
